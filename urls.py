...
from . import views
from .views import test_full_report
from .views import run_rmp_test
...
urlpatterns = [
    ...
    path('run-rmp-test/', views.run_rmp_test, name='run_rmp_test'),
    path('run-duo-paternity-test/', views.run_duo_paternity_test, name='run_duo_paternity_test'),
    path('run-trio-paternity-test/', views.run_trio_paternity_test, name='run_trio_paternity_test'),



    path('report/', views.report, name='report'),
    path('report/<int:test_id>/', views.test_full_report, name='test_result'),
